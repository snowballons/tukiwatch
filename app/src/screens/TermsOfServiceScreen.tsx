  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.paragraph}>
          Stream content accessed through the App is owned by respective content creators and
          platforms. We do not claim ownership of third-party content.
        </Text>

        <Text style={styles.sectionTitle}>6. Third-Party Services</Text>
        <Text style={styles.paragraph}>
          The App integrates with third-party streaming platforms. Your use of these platforms is
          subject to their respective terms of service. We are not responsible for the availability,
          content, or policies of third-party services.
        </Text>
